                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="addProduct">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="file" class="form-control input-file" wire:model="thurmbnail"/>
                                    @if($thurmbnail)
                                        <img src="{{ $thurmbnail->temporaryUrl() }}" width="120"/>
                                    @endif
                                    @error('thurmbnail')<p class="text-danger">{{ $message }}</p>@enderror
                                </div>
                            </div>
                            <div class="form-group">
